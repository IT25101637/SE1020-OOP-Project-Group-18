            ...
            cardElement.innerHTML = `
                <div class="card-display">
                    ...
                    <div class="card-details">
                        ...
                        ${card.isDefault ? '<span class="default-badge"><i class="fas fa-check"></i> Default</span>' : ''}
                    </div>
                </div>
                <div class="card-actions">
                    ${!card.isDefault ? `<button class="btn btn-sm btn-secondary" onclick="PaymentCardManager.setDefault('${card.paymentCardId}')">Set Default</button>` : ''}
